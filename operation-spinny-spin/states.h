...
extern const char *DavidStateNames[DAVID_STATE_COUNT];

class Spinny_Spin_Machine {
	public:
	MainState mainState;
	...
	// Dispensing / Feed Operation Parameters
	...
	const char* davidStateStr() const;
};
#endif // STATES_H