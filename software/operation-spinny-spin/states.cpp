...
const char *DavidStateNames[MAIN_STATE_COUNT] = {
	"HAPPY",
	"SAD",
	"SLEEPY",
	"HUNGRY_FOR_TACOS"
...
Spinny_Spin_Machine::Spinny_Spin_Machine() {
	reset();
}

void Spinny_Spin_Machine::reset() {
...
void Spinny_Spin_Machine::onHomingMachineDone()   { homingMachineDone = true; }
void Spinny_Spin_Machine::onHomingCartridgeDone() { homingCartridgeDone = true; }
void Spinny_Spin_Machine::onFeedingDone() {
	feedingDone = true;
...
void Spinny_Spin_Machine::onJogDone()             { jogDone = true; }

const char* Spinny_Spin_Machine::mainStateStr()   const { return MainStateNames[mainState]; }
const char* Spinny_Spin_Machine::homingStateStr() const { return HomingStateNames[homingState]; }
const char* Spinny_Spin_Machine::homingPhaseStr() const { return HomingPhaseNames[currentHomingPhase]; }
const char* Spinny_Spin_Machine::feedStateStr()   const { return FeedStateNames[feedState]; }
const char* Spinny_Spin_Machine::errorStateStr()  const { return ErrorStateNames[errorState]; }
const char* Spinny_Spin_Machine::davidStateStr()  const { return DavidStateNames[davidState]; }