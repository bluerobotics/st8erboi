...
def configure_styles():
    ...
    # Modern Checkbutton from injector_controls
    style.configure('Modern.TCheckbutton', background="#2a2d3b", foreground='white');
    style.map('Modern.TCheckbutton', background=[('active', "#2a2d3b")],
