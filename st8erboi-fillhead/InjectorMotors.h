...
extern float globalTorqueLimit;    // General torque limit, set by moveInjectorMotors
extern float torqueOffset;         // Global torque offset, set by USER_CMD_SET_TORQUE_OFFSET
...
// The 'torque_limit' parameter will set the globalTorqueLimit for checkInjectorTorqueLimit.
